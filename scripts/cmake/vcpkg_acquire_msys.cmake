...
function(vcpkg_acquire_msys PATH_TO_ROOT_OUT)
  ...
  if() #_am_PACKAGES
    ...
    file(APPEND msys-pacman-${TARGET_TRIPLET}-out.log "${DB_LOCK}")
    file(APPEND msys-pacman-${TARGET_TRIPLET}-out.log "HEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHEREHERE")
